...
| R-TOOLS-03 | Plugin discovery/execute remains stable, including daemon-owned startup scan/init and install-time hot loading into the live registry | plugin tests + daemon tests + route tests | L1/L2 |
