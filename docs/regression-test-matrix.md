...
| R-TOOLS-03 | Plugin discovery/execute remains stable, including daemon-owned startup scan/init and install/enable-time hot syncing into the live registry and semantic tool surface | plugin tests + daemon tests + route tests | L1/L2 |
