...
| 12 | Plugin and script runtime | [12-plugin-and-script-runtime.md](./systems/12-plugin-and-script-runtime.md) | In progress | Deepened and partially remediated: daemon startup now owns plugin registry construction/scan/init and startup manifest parsing now recovers real tool definitions; install-time hot registration is still open |
