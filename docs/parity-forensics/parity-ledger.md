...
| 8 | MCP and external integrations | [08-mcp-and-external-integrations.md](./systems/08-mcp-and-external-integrations.md) | Reopened for v1.0.7 | Transport/runtime governance remains strong, and v1.0.7 now has the central SSE validation harness plus endpoint/auth-capable transport and shared config conversion for `PAR-008`, but real multi-target proof is still outstanding |
