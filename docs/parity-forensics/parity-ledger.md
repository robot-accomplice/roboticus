...
| 11 | Scheduler, automation, and cron runtime | [11-scheduler-automation-and-cron-runtime.md](./systems/11-scheduler-automation-and-cron-runtime.md) | In progress | Deepened and partially remediated: durable cron worker remains the lifecycle owner, `RunCronJobNow` now reuses that lifecycle, daemon-owned consolidation and maintenance now use the shared heartbeat runtime, and the remaining open seams are the finance/session heartbeat families plus deeper runtime classification |
