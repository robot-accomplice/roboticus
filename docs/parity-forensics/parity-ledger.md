...
| 12 | Plugin and script runtime | [12-plugin-and-script-runtime.md](./systems/12-plugin-and-script-runtime.md) | In progress | Deepened and materially remediated: daemon startup owns plugin registry construction/scan/init, startup parsing recovers real tool definitions, and install-time plugin registration now hot-loads into the same live registry; main open seams are script-runtime classification and core tool-surface integration |
