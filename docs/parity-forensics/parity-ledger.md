...
| 12 | Plugin and script runtime | [12-plugin-and-script-runtime.md](./systems/12-plugin-and-script-runtime.md) | In progress | Deepened and materially remediated: daemon startup owns plugin registry construction/scan/init, startup parsing recovers real tool definitions, and install/enable now hot-sync plugin tools plus descriptor embeddings into the same live registry-owned semantic tool surface; main open seam is script-runtime classification |
