...
func pubKeyToAddress(pub *ecdsa.PublicKey) string {
	xBytes := pub.X.Bytes() //nolint:staticcheck // deprecated elliptic.Curve API; functional for secp256k1
	yBytes := pub.Y.Bytes() //nolint:staticcheck // deprecated elliptic.Curve API; functional for secp256k1
