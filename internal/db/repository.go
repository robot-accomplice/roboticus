...
func (h *HippocampusRegistry) SyncBuiltinTables(ctx context.Context) error {
	tables := []TableEntry{
		...
		{"relationship_memory", "Entity interaction tracking", `["id","entity_id","entity_name","trust_score","interaction_summary","interaction_count","last_interaction","created_at","updated_at"]`, false},
		{"knowledge_facts", "Typed graph facts and dependencies", `["id","subject","relation","object","source_table","source_id","confidence","created_at","updated_at"]`, false},
