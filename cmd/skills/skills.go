...
var skillsListCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		data, err := cmdutil.APIGet("/api/skills")
		if err != nil {
			return err
		}
...
var skillsReloadCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		data, err := cmdutil.APIPost("/api/skills/reload", nil)
		if err != nil {
			return err
		}
		cmdutil.PrintJSON(data)
...
var skillsCatalogCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		data, err := cmdutil.APIGet("/api/skills/catalog")
		if err != nil {
			return err
		}
		cmdutil.PrintJSON(data)
...
var skillsShowCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		data, err := cmdutil.APIGet("/api/skills/" + args[0])
		if err != nil {
			return err
		}
		cmdutil.PrintJSON(data)
...
var skillsCatalogInstallCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		data, err := cmdutil.APIPost("/api/skills/catalog/install", map[string]any{
			"names": args,
		})
		if err != nil {
			return err
...
var skillsCatalogActivateCmd = &cobra.Command{
	...
	Args:  cobra.MinimumNArgs(1),
	RunE: func(cmd *cobra.Command, args []string) error {
		data, err := cmdutil.APIPost("/api/skills/catalog/activate", map[string]any{
			"names": args,
		})
		if err != nil {
			return err
...
var skillsImportCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		for _, sf := range files {
			_, postErr := cmdutil.APIPost("/api/skills", map[string]any{
...
var skillsExportCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		if len(args) == 0 {
			...
			for _, id := range args {
				data, err := cmdutil.APIGet("/api/skills/" + id)
				if err != nil {
