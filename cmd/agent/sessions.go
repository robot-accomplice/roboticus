...
var sessionsListCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		data, err := cmdutil.APIGet("/api/sessions")
		if err != nil {
			return err
		}
		sessions, _ := data["sessions"].([]any)
		if len(sessions) == 0 {
			cmdutil.OutputMessage("No sessions.")
			return nil
		}
		cmdutil.OutputResult(data, func(d any) {
...
var sessionsShowCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		data, err := cmdutil.APIGet("/api/sessions/" + args[0])
		if err != nil {
			return err
		}
		cmdutil.PrintJSON(data)

		msgs, err := cmdutil.APIGet("/api/sessions/" + args[0] + "/messages")
		if err == nil {
...
var sessionsDeleteCmd = &cobra.Command{
	...
	Args:  cobra.ExactArgs(1),
	RunE: func(cmd *cobra.Command, args []string) error {
		if err := cmdutil.APIDelete("/api/sessions/" + args[0]); err != nil {
			return err
		}
...
var sessionsExportCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		msgs, err := cmdutil.APIGet("/api/sessions/" + sessionID + "/messages")
		if err != nil {
			return err
		}
...
var sessionsCreateCmd = &cobra.Command{
	...
	Args:  cobra.ExactArgs(1),
	RunE: func(cmd *cobra.Command, args []string) error {
		data, err := cmdutil.APIPost("/api/sessions", map[string]any{
			"agent_id": args[0],
		})
		if err != nil {
			return err
...
var sessionsBackfillNicknamesCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		data, err := cmdutil.APIPost("/api/sessions/backfill-nicknames", nil)
		if err != nil {
			return err
		}
		cmdutil.PrintJSON(data)
