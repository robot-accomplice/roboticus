...
var adminRosterCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		data, err := cmdutil.APIGet("/api/roster")
		if err != nil {
			return err
		}
...
var adminModelsCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		data, err := cmdutil.APIGet("/api/models/available")
		if err != nil {
			return err
		}
		cmdutil.PrintJSON(data)
...
var adminSubagentsCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		data, err := cmdutil.APIGet("/api/subagents")
		if err != nil {
			return err
		}
		cmdutil.PrintJSON(data)
...
var adminStatsCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		for _, endpoint := range []struct{ name, path string }{
			...
			data, err := cmdutil.APIGet(endpoint.path)
			if err != nil {
