...
var channelsListCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		data, err := cmdutil.APIGet("/api/channels/status")
		if err != nil {
			return err
		}
...
var channelsTestCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		data, err := cmdutil.APIPost("/api/channels/"+args[0]+"/test", nil)
		if err != nil {
			return err
		}
...
var channelsDeadLetterCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		data, err := cmdutil.APIGet("/api/channels/dead-letter")
		if err != nil {
			return err
		}
...
var channelsReplayCmd = &cobra.Command{
	...
	Args:  cobra.ExactArgs(1),
	RunE: func(cmd *cobra.Command, args []string) error {
		data, err := cmdutil.APIPost("/api/channels/dead-letter/"+args[0]+"/replay", nil)
		if err != nil {
			return err
		}
